...
public interface VKApiService{
    @GET("https://api.vk.com/method/friends.get?&v=5.131&fields=contacts,sex,photo_100,photo_200_orig,photo_50&order=hints")
    ...
    Call<VKUserResponse> getUser(@Query("user_id") Integer userID, @Query("access_token") String token);
